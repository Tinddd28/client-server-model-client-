...
QT_MOC_LITERAL(3, 15, 4), // "send"
QT_MOC_LITERAL(4, 20, 15), // "on_back_clicked"
QT_MOC_LITERAL(5, 36, 15) // "on_edit_clicked"

    },
    "edituser\0back\0\0send\0on_back_clicked\0"
    "on_edit_clicked"
};
...
void edituser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->send((*reinterpret_cast< QJsonDocument(*)>(_a[1]))); break;
        ...
        {
            using _t = void (edituser::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&edituser::back)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (edituser::*)(QJsonDocument );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&edituser::send)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject edituser::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_edituser.data,
    qt_meta_data_edituser,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 1
void edituser::send(QJsonDocument _t1)
{
